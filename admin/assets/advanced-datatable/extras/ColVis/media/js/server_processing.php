...
$sQuery = "
		...
		$sLimit
	";
$rResult = mysqli_query($sQuery, $gaSql['link']) or die(mysqli_error($koneksi));

/* Data set length after filtering */
$sQuery = "
		SELECT FOUND_ROWS()
	";
$rResultFilterTotal = mysqli_query($sQuery, $gaSql['link']) or die(mysqli_error($koneksi));
...
$sQuery = "
		...
		FROM   $sTable
	";
$rResultTotal = mysqli_query($sQuery, $gaSql['link']) or die(mysqli_error($koneksi));
