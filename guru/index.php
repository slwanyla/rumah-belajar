        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item mt-4 p-3">
                        <a href="logout.php" class="menu-link bg-danger">
                            <i class="menu-icon tf-icons bx bx-log-out"></i> <!-- Ikon Rumah untuk Dashboard -->
                            <div data-i18n="Kelas">Logout</div>
                        </a>
                    </li>
                </ul>
            </aside>
